...
disc_opt = Adam(params=disc.parameters(), lr=config.LEARNING_RATE, betas=config.BETAS)
...
for epoch in range(config.EPOCHS):
    ...
    for real, _ in tqdm(train_loader):  # TODO: Train generator function?
        ...
        fake_noise = utils.sample_noise(curr_batch_size, config.Z_DIM, config.DEVICE)
        fake = gen(fake_noise)
